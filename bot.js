...
// Sql
const QueenAmdiDB = config.DATABASE.define('PODDA', {
    info: {
...
async function queenAmdi () {
    ...
    conn.on('connecting', async () => {
        console.log(`${chalk.green.bold('PODDA')}${chalk.blue.bold('CL')}
${chalk.white.bold('Version:')} ${chalk.red.bold(config.VERSION)}
${chalk.blue.italic('ℹ️ PODDA WhatsApp වෙත සම්බන්ධ වෙමින් පවතී... කරුණාකර රැඳී සිටින්න.')}`);
    });
    

    conn.on('open', async () => {
        console.log(
            chalk.green.bold('✅ PODDA පුරනය වීම සාර්ථකයි!')
        );

        console.log(
            chalk.blueBright.italic('⬇️ CL බාහිර plugins ස්ථාපනය කිරීම...')
        );
        ...
        console.log(
            chalk.blueBright.italic('⬇️ CL Plugins ස්ථාපනය කිරීම...')
        );
        ...
        console.log(
            chalk.green.bold('✅ PODDA Plugins ස්ථාපනය කර ඇත! PODDA දැන් ඔබට භාවිතා කළ හැකිය.')
        );
                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if (sendMsg) {
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                await conn.sendMessage(conn.user.jid, '*-- දෝෂ වාර්තාව [PODDA] --*\n\n' + 
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- බොට් වාර්තාව [PODDA] --*\n' + 
